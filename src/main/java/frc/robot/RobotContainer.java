...
import frc.robot.subsystems.arm.ArmSparkIO;
...
public class RobotContainer {
  ...
  private final ArmSubsystem armSubsystem = new ArmSubsystem(new ArmSparkIO());
  ...
  private void configureBindings() {
    ...
    m_driverController.b().whileTrue(armSubsystem.zeroDegreesCommand());
